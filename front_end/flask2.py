...
def hello():
	...
	databaseData = jsonify(AL=states[0],AK=states[1],AZ=states[2],AR=states[3],CA=states[4],CO=states[5],CT=states[6],
		...
		WI=states[47],WV=states[48],WY=states[49]).get_data()

	return render_template('index.html', databaseData=databaseData)
